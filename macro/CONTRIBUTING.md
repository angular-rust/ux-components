...
```
git clone git@github.com:$USER/ux-components.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-components` repository on GitHub to your computer.
