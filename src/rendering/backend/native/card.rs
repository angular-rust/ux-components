...
impl Is<Widget> for Card {}

impl AsRef<Widget> for Card {
    fn as_ref(&self) -> &Widget {
        &self.inner
    }
}

impl Is<Actor> for Card {}

impl AsRef<Actor> for Card {
...
pub trait CardExt: 'static {
    ...
    /// @action: A #PushAction
    ///
    /// Sets @action as the action for @button. @Card will take its label and
    /// icon from @action.
    ///
