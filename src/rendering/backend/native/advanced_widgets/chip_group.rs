...
impl Object for ChipGroup {}
impl Is<ChipGroup> for ChipGroup {}

impl AsRef<ChipGroup> for ChipGroup {
    fn as_ref(&self) -> &ChipGroup {
        self
    }
}
...
pub trait ChipGroupExt: 'static {
    ...
    /// @group: A #ChipGroup
    ///
    /// Get the value of the #ChipGroup:allow-no-active property.
    ///
    ...
    /// owned by the #ChipGroup and should not be modified by the application.
    ///
    ...
    /// @button: A #Button
    ///
    /// Remove @button from the #ChipGroup
    ///
    ...
    ///
    /// Set the value of the #ChipGroup:allow-no-active property.
    ///
...
impl<O: Is<ChipGroup>> ChipGroupExt for O {
    /// add:
    /// @group: A #ChipGroup
    /// @button: A #Button
    ///
