...
// glib_wrapper! {
//     pub struct Widget(Object<ffi::MxWidget, ffi::MxWidgetClass, WidgetClass>) @extends clutter::Actor;

//     match fn {
//         get_type => || ffi::mx_widget_get_type(),
//     }
// }
...
//     fn apply_style<P: IsA<Style>>(&self, style: &P);
...
//     fn set_menu<P: IsA<Menu>>(&self, menu: &P);
...
//     fn get_available_area(&self, allocation: &clutter::ActorBox, area: &mut clutter::ActorBox) {
//         unsafe {
//             ffi::mx_widget_get_available_area(
//                 self.as_ref().to_glib_none().0,
...
//     fn get_background_color(&self) -> Option<clutter::Color> {
//         unsafe {
//             from_glib_none(ffi::mx_widget_get_background_color(
//                 self.as_ref().to_glib_none().0,
//             ))
//         }
//     }
...
//     fn get_disabled(&self) -> bool {
//         unsafe {
//             from_glib(ffi::mx_widget_get_disabled(
//                 self.as_ref().to_glib_none().0,
//             ))
//         }
//     }
...
//     fn get_menu(&self) -> Option<Menu> {
//         unsafe { from_glib_none(ffi::mx_widget_get_menu(self.as_ref().to_glib_none().0)) }
//     }
...
//     fn get_tooltip_delay(&self) -> u32 {
//         unsafe { ffi::mx_widget_get_tooltip_delay(self.as_ref().to_glib_none().0) }
//     }

//     fn get_tooltip_text(&self) -> Option<GString> {
//         unsafe {
//             from_glib_none(ffi::mx_widget_get_tooltip_text(
//                 self.as_ref().to_glib_none().0,
//             ))
//         }
//     }
...
//     fn hide_tooltip(&self) {
//         unsafe {
//             ffi::mx_widget_hide_tooltip(self.as_ref().to_glib_none().0);
//         }
//     }

//     fn long_press_cancel(&self) {
//         unsafe {
//             ffi::mx_widget_long_press_cancel(self.as_ref().to_glib_none().0);
//         }
//     }

//     fn long_press_query(&self, event: &mut clutter::Event) {
//         unsafe {
//             ffi::mx_widget_long_press_query(
//                 self.as_ref().to_glib_none().0,
...
//     fn set_disabled(&self, disabled: bool) {
//         unsafe {
//             ffi::mx_widget_set_disabled(self.as_ref().to_glib_none().0, disabled.to_glib());
//         }
//     }

//     fn set_menu<P: IsA<Menu>>(&self, menu: &P) {
//         unsafe {
//             ffi::mx_widget_set_menu(
//                 self.as_ref().to_glib_none().0,
...
//     fn set_tooltip_delay(&self, delay: u32) {
//         unsafe {
//             ffi::mx_widget_set_tooltip_delay(self.as_ref().to_glib_none().0, delay);
//         }
//     }

//     fn set_tooltip_text(&self, text: &str) {
//         unsafe {
//             ffi::mx_widget_set_tooltip_text(
//                 self.as_ref().to_glib_none().0,
//                 text.to_glib_none().0,
//             );
//         }
...
//     fn show_tooltip(&self) {
//         unsafe {
//             ffi::mx_widget_show_tooltip(self.as_ref().to_glib_none().0);
//         }
//     }
