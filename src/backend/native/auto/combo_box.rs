...
// glib_wrapper! {
//     pub struct ComboBox(Object<ffi::MxComboBox, ffi::MxComboBoxClass, ComboBoxClass>) @extends Widget, clutter::Actor;

//     match fn {
//         get_type => || ffi::mx_combo_box_get_type(),
//     }
// }
...
impl ComboBox {
    pub fn new() -> ComboBox {
        ...
        // unsafe { clutter::Actor::from_glib_none(ffi::mx_combo_box_new()).unsafe_cast() }
        unimplemented!()
    }
}
...
pub trait ComboBoxExt: 'static {
    ...
    fn get_active_icon_name(&self) -> Option<GString>;
...
//     fn append_text(&self, text: &str) {
//         // unsafe {
//         //     ffi::mx_combo_box_append_text(self.as_ref().to_glib_none().0, text.to_glib_none().0);
//         // }
//         unimplemented!()
//     }
...
//     fn get_active_icon_name(&self) -> Option<GString> {
//         // unsafe {
//         //     from_glib_none(ffi::mx_combo_box_get_active_icon_name(
...
//     fn get_active_text(&self) -> Option<GString> {
//         // unsafe {
//         //     from_glib_none(ffi::mx_combo_box_get_active_text(
//         //         self.as_ref().to_glib_none().0,
//         //     ))
//         // }
//         unimplemented!()
...
//     fn get_index(&self) -> i32 {
//         // unsafe { ffi::mx_combo_box_get_index(self.as_ref().to_glib_none().0) }
//         unimplemented!()
//     }

//     fn insert_text(&self, position: i32, text: &str) {
//         // unsafe {
//         //     ffi::mx_combo_box_insert_text(
//         //         self.as_ref().to_glib_none().0,
//         //         position,
//         //         text.to_glib_none().0,
//         //     );
...
//     fn insert_text_with_icon(&self, position: i32, text: &str, icon: &str) {
//         // unsafe {
//         //     ffi::mx_combo_box_insert_text_with_icon(
//         //         self.as_ref().to_glib_none().0,
//         //         position,
//         //         text.to_glib_none().0,
//         //         icon.to_glib_none().0,
...
//     fn remove_all(&self) {
//         // unsafe {
//         //     ffi::mx_combo_box_remove_all(self.as_ref().to_glib_none().0);
//         // }
//         unimplemented!()
//     }
...
//     fn remove_text(&self, position: i32) {
//         // unsafe {
//         //     ffi::mx_combo_box_remove_text(self.as_ref().to_glib_none().0, position);
//         // }
//         unimplemented!()
//     }
...
//     fn set_active_icon_name(&self, icon_name: Option<&str>) {
//         // unsafe {
//         //     ffi::mx_combo_box_set_active_icon_name(
//         //         self.as_ref().to_glib_none().0,
...
//     fn set_active_text(&self, text: &str) {
//         // unsafe {
//         //     ffi::mx_combo_box_set_active_text(
//         //         self.as_ref().to_glib_none().0,
//         //         text.to_glib_none().0,
//         //     );
//         // }
...
//     fn set_index(&self, index: i32) {
//         // unsafe {
//         //     ffi::mx_combo_box_set_index(self.as_ref().to_glib_none().0, index);
//         // }
//         unimplemented!()
//     }
