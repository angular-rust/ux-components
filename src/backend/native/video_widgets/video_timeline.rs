...
pub struct VideoTimeline {
    props: RefCell<VideoTimelineProps>,
}

impl VideoTimeline {
    pub fn new() -> VideoTimeline {
...
impl Object for VideoTimeline {}
impl Is<VideoTimeline> for VideoTimeline {}

impl AsRef<VideoTimeline> for VideoTimeline {
    fn as_ref(&self) -> &VideoTimeline {
        self
    }
}

pub trait VideoTimelineExt: 'static {
    /// add:
    /// @group: A #VideoTimeline
    /// @button: A #Button
    ///
    /// Add @button to the #VideoTimeline.
    ///
    ...
    /// @group: A #VideoTimeline
    ///
    /// Get the value of the #VideoTimeline:allow-no-active property.
    ///
    ...
    /// owned by the #VideoTimeline and should not be modified by the application.
    ///
    ...
    /// @button: A #Button
    ///
    /// Remove @button from the #VideoTimeline
    ///
    ...
    ///
    /// Set the value of the #VideoTimeline:allow-no-active property.
    ///
...
impl<O: Is<VideoTimeline>> VideoTimelineExt for O {
    ...
    fn connect_property_active_button_notify<F: Fn(&Self) + 'static>(
        ...
        //     f(&VideoTimeline::from_glib_borrow(this).unsafe_cast_ref())
        // }
        // unsafe {
...
impl fmt::Display for VideoTimeline {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "VideoTimeline")
    }
}
