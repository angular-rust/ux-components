...
#[derive(Debug)]
pub struct ListitemGroup {
    props: RefCell<ListitemGroupProps>,
}

impl ListitemGroup {
    pub fn new() -> ListitemGroup {
...
impl Default for ListitemGroup {
    fn default() -> Self {
        Self::new()
    }
}

impl Object for ListitemGroup {}
impl Is<ListitemGroup> for ListitemGroup {}

impl AsRef<ListitemGroup> for ListitemGroup {
    fn as_ref(&self) -> &ListitemGroup {
        self
    }
}

pub trait ListitemGroupExt: 'static {
    /// add:
    /// @group: A #ListitemGroup
    /// @button: A #Button
    ///
    /// Add @button to the #ListitemGroup.
    ///
    ...
    /// @group: A #ListitemGroup
    ///
    /// Get the value of the #ListitemGroup:allow-no-active property.
    ///
    ...
    /// owned by the #ListitemGroup and should not be modified by the application.
    ///
    ...
    /// @button: A #Button
    ///
    /// Remove @button from the #ListitemGroup
    ///
    ...
    ///
    /// Set the value of the #ListitemGroup:allow-no-active property.
    ///
...
impl<O: Is<ListitemGroup>> ListitemGroupExt for O {
    /// add:
    /// @group: A #ListitemGroup
    /// @button: A #Button
    ///
    ...
    fn connect_property_active_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> HandlerId {
        ...
        //     f(&ListitemGroup::from_glib_borrow(this).unsafe_cast_ref())
        // }
        // unsafe {
...
impl fmt::Display for ListitemGroup {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ListitemGroup")
    }
}
