...
impl Formfield {
    ...
    pub fn with_text(text: &str) -> Formfield {
        // assert_initialized_main_thread!();
        // unsafe {
...
impl Object for Formfield {}
impl Is<Formfield> for Formfield {}

impl AsRef<Formfield> for Formfield {
    fn as_ref(&self) -> &Formfield {
        self
    }
}

impl Is<Widget> for Formfield {}

impl AsRef<Widget> for Formfield {
    fn as_ref(&self) -> &Widget {
        &self.widget
    }
}

impl Is<Actor> for Formfield {}

impl AsRef<Actor> for Formfield {
...
pub trait FormfieldExt: 'static {
    // /// get_clutter_text:
    // /// @entry: a #Formfield
    // ///
    // /// Retrieve the internal #Text so that extra parameters can be set
    // ///
    // /// Returns: (transfer none): the #Text used by #Formfield. The entry is
    // /// owned by the #Formfield and should not be unref'ed by the application.
    // ///
    ...
    /// #Formfield and should not be freed or modified.
    ///
    ...
    /// This string is owned by the #Formfield and should not be freed or modified.
    ///
    ...
    /// and the suffix to "-highlight" #Formfield will look for "primary-icon-highlight.png"
    ///
...
impl<O: Is<Formfield>> FormfieldExt for O {
    // /// get_clutter_text:
    // /// @entry: a #Formfield
    // ///
    // /// Retrieve the internal #Text so that extra parameters can be set
    ...
    fn connect_primary_icon_clicked<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        //     this: *mut ffi::Formfield,
        //     f: glib_sys::gpointer,
        // ) where
        //     P: Is<Formfield>,
        // {
        //     let f: &F = &*(f as *const F);
        //     f(&Formfield::from_glib_borrow(this).unsafe_cast_ref())
        // }
        // unsafe {
