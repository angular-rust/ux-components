...
impl Textarea {
    ...
    pub fn with_text(text: &str) -> Textarea {
        // assert_initialized_main_thread!();
        // unsafe {
...
impl Object for Textarea {}
impl Is<Textarea> for Textarea {}

impl AsRef<Textarea> for Textarea {
    fn as_ref(&self) -> &Textarea {
        self
    }
}

impl Is<Widget> for Textarea {}

impl AsRef<Widget> for Textarea {
    fn as_ref(&self) -> &Widget {
        &self.widget
    }
}

impl Is<Actor> for Textarea {}

impl AsRef<Actor> for Textarea {
...
pub trait TextareaExt: 'static {
    // /// get_clutter_text:
    // /// @entry: a #Textarea
    // ///
    // /// Retrieve the internal #Text so that extra parameters can be set
    // ///
    // /// Returns: (transfer none): the #Text used by #Textarea. The entry is
    // /// owned by the #Textarea and should not be unref'ed by the application.
    // ///
    ...
    /// #Textarea and should not be freed or modified.
    ///
    ...
    /// This string is owned by the #Textarea and should not be freed or modified.
    ///
    ...
    /// and the suffix to "-highlight" #Textarea will look for "primary-icon-highlight.png"
    ///
...
impl<O: Is<Textarea>> TextareaExt for O {
    // /// get_clutter_text:
    // /// @entry: a #Textarea
    // ///
    // /// Retrieve the internal #Text so that extra parameters can be set
    ...
    fn connect_primary_icon_clicked<F: Fn(&Self) + 'static>(&self, f: F) -> HandlerId {
        ...
        //     this: *mut ffi::Textarea,
        //     f: glib_sys::gpointer,
        // ) where
        //     P: Is<Textarea>,
        // {
        //     let f: &F = &*(f as *const F);
        //     f(&Textarea::from_glib_borrow(this).unsafe_cast_ref())
        // }
        // unsafe {
