...
pub struct NavigationRailElement {
...
impl Debug for NavigationRailElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("NavigationRailElement").finish()
    }
}

impl NavigationRailElement {
...
impl AsRef<RefCell<WidgetComponent>> for NavigationRailElement {
...
impl Element for NavigationRailElement {
    ...
    fn update(&self, dt: f32) {
        log::info!("Update NavigationRail");
        let component = self.component.borrow();
