...
struct UserAccountsDrawerHeaderState {
    depth_idx: f32, // = 0.0;

    mouse_down: bool, // = false;
}

/// A UserAccountsDrawerHeader is a layout-only object and it do not requires a rendering instance.
/// It and handles all incoming events, propagating them to the children.
/// Additional Signals: none

pub struct UserAccountsDrawerHeaderElement {
    ...
    state: RefCell<UserAccountsDrawerHeaderState>,

    // The node in layout system
    pub node: Node,
}

impl Debug for UserAccountsDrawerHeaderElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("UserAccountsDrawerHeaderElement").finish()
    }
}

impl UserAccountsDrawerHeaderElement {
    pub fn new(widget: &UserAccountsDrawerHeader) -> Self {
        ...
        //     log::warn!("Got signal to render UserAccountsDrawerHeader");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for UserAccountsDrawerHeaderElement {
...
impl Element for UserAccountsDrawerHeaderElement {
    ...
    fn mousedown(&self, e: &mut MouseEvent) {
        ...
        // Scaffold should used as root widget after UserAccountsDrawerHeaderApp
    ...
    fn update(&self, dt: f32) {
        log::info!("Update UserAccountsDrawerHeaderElement");
        let component = self.component.borrow();
