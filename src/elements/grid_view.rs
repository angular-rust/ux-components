...
/// A GridView is a layout-only object and it do not requires a rendering instance.
/// It and handles all incoming events, propagating them to the children.
/// Additional Signals: none

pub struct GridViewElement {
    ...
    state: RefCell<GridViewState>,
    // The node in layout system
    pub node: Node,
}

impl Debug for GridViewElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("GridViewElement").finish()
    }
}

impl GridViewElement {
    pub fn new(widget: &GridView) -> Self {
        ...
        //     log::warn!("Got signal to render GridView");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for GridViewElement {
...
impl Element for GridViewElement {
    ...
    fn update(&self, dt: f32) {
        log::info!("Update GridViewElement");
        let component = self.component.borrow();
    ...
    fn render(&self) {
        log::info!("Render GridViewElement");
