...
/// A Transform is a layout-only object and it do not requires a rendering instance.
...
impl Debug for TransformElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("TransformElement").finish()
    }
}

impl TransformElement {
    pub fn new(widget: &Transform) -> Self {
        ...
        //     log::warn!("Got signal to render Transform");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for TransformElement {
...
impl Element for TransformElement {
    ...
    fn update(&self, dt: f32) {
        log::info!("Update TransformElement");
        let component = self.component.borrow();
