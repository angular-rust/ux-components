...
/// A Flow is a layout-only object and it do not requires a rendering instance.
...
impl Debug for FlowElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("FlowElement").finish()
    }
}

impl FlowElement {
    pub fn new(widget: &Flow) -> Self {
        ...
        //     log::warn!("Got signal to render Flow");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for FlowElement {
