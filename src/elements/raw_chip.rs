...
#[derive(Debug, Clone)]
pub struct RawChipStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct RawChipElement {
    ...
    pub onchange: Signal<RawChipStateChangeEvent>,
...
impl Debug for RawChipElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("RawChipElement").finish()
    }
}

impl RawChipElement {
    pub fn new(widget: &RawChip) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&RawChipStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for RawChipElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for RawChipElement {
    fn destroy(&self) {
        // self.base.destroy();
