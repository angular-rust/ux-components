...
/// A Row is a layout-only object and it do not requires a rendering instance.
...
impl Debug for RowElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("RowElement").finish()
    }
}
...
impl RowElement {
    pub fn new(widget: &Row) -> Self {
        ...
        //     log::warn!("Got signal to render Row");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for RowElement {
