...
#[derive(Debug, Clone)]
pub struct InputChipStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct InputChipElement {
    ...
    pub onchange: Signal<InputChipStateChangeEvent>,
...
impl Debug for InputChipElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("InputChipElement").finish()
    }
}

impl InputChipElement {
    pub fn new(widget: &InputChip) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&InputChipStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for InputChipElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for InputChipElement {
    fn destroy(&self) {
        // self.base.destroy();
