...
#[derive(Debug, Clone)]
pub struct RefreshIndicatorStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct RefreshIndicatorElement {
    ...
    pub onchange: Signal<RefreshIndicatorStateChangeEvent>,
...
impl RefreshIndicatorElement {
    pub fn new(widget: &RefreshIndicator) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&RefreshIndicatorStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for RefreshIndicatorElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for RefreshIndicatorElement {
    fn destroy(&self) {
        // self.base.destroy();
