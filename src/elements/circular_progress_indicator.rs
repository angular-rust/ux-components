...
#[derive(Debug, Clone)]
pub struct CircularProgressIndicatorStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct CircularProgressIndicatorElement {
    ...
    pub onchange: Signal<CircularProgressIndicatorStateChangeEvent>,
...
impl CircularProgressIndicatorElement {
    pub fn new(widget: &CircularProgressIndicator) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&CircularProgressIndicatorStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for CircularProgressIndicatorElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for CircularProgressIndicatorElement {
    fn destroy(&self) {
        // self.base.destroy();
