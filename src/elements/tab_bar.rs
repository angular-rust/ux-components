...
#[derive(Debug, Clone)]
pub struct TabBarStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct TabBarElement {
    ...
    pub onchange: Signal<TabBarStateChangeEvent>,
...
impl Debug for TabBarElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("TabBarElement").finish()
    }
}

impl TabBarElement {
    pub fn new(widget: &TabBar) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&TabBarStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for TabBarElement {
