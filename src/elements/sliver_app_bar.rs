...
pub struct SliverAppBarElement {
    ...
    state: RefCell<SliverAppBarState>,
...
impl Debug for SliverAppBarElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("SliverAppBarElement").finish()
    }
}

impl SliverAppBarElement {
    pub fn new(widget: &SliverAppBar) -> Self {
...
impl AsRef<RefCell<WidgetComponent>> for SliverAppBarElement {
...
impl Element for SliverAppBarElement {
