...
#[derive(Debug, Clone)]
pub struct CheckboxStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct CheckboxElement {
    ...
    pub onchange: Signal<CheckboxStateChangeEvent>,
...
impl Debug for CheckboxElement {
...
impl CheckboxElement {
    pub fn new(widget: &Checkbox) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&CheckboxStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for CheckboxElement {
