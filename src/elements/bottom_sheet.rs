...
#[derive(Debug, Clone)]
pub struct BottomSheetStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct BottomSheetElement {
    ...
    pub onchange: Signal<BottomSheetStateChangeEvent>,
...
impl BottomSheetElement {
    pub fn new(widget: &BottomSheet) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&BottomSheetStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for BottomSheetElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for BottomSheetElement {
    fn destroy(&self) {
        // self.base.destroy();
