...
#[derive(Debug, Clone)]
pub struct FilterChipStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct FilterChipElement {
    ...
    pub onchange: Signal<FilterChipStateChangeEvent>,
...
impl Debug for FilterChipElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("FilterChipElement").finish()
    }
}

impl FilterChipElement {
    pub fn new(widget: &FilterChip) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&FilterChipStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for FilterChipElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for FilterChipElement {
    fn destroy(&self) {
        // self.base.destroy();
