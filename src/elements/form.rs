...
/// A Form is a layout-only object and it do not requires a rendering instance.
...
impl Debug for FormElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("FormElement").finish()
    }
}

impl FormElement {
    pub fn new(widget: &Form) -> Self {
        ...
        //     log::warn!("Got signal to render Form");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for FormElement {
