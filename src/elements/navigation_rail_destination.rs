...
pub struct NavigationRailDestinationElement {
...
impl Debug for NavigationRailDestinationElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("ButtonElement").finish()
    }
}

impl NavigationRailDestinationElement {
    pub fn new(widget: &NavigationRailDestination) -> Self {
...
impl AsRef<RefCell<WidgetComponent>> for NavigationRailDestinationElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for NavigationRailDestinationElement {
    fn mousedown(&self, e: &mut MouseEvent) {
        ...
        log::info!("NavigationRailDestinationElement clicked");
        // self.state.borrow_mut().mouse_down = true;
        // let component = self.component.borrow();
        // component.onmousedown.emit(e);
