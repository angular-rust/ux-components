...
#[derive(Debug, Clone)]
pub struct AboutListTileStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct AboutListTileElement {
    ...
    pub onchange: Signal<AboutListTileStateChangeEvent>,
...
impl Debug for AboutListTileElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("AboutListTileElement").finish()
    }
}

impl AboutListTileElement {
    pub fn new(widget: &AboutListTile) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&AboutListTileStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for AboutListTileElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for AboutListTileElement {
    fn destroy(&self) {
        // self.base.destroy();
