...
#[derive(Debug, Clone)]
pub struct ActionChipStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ActionChipElement {
    ...
    pub onchange: Signal<ActionChipStateChangeEvent>,
...
impl Debug for ActionChipElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("ActionChipElement").finish()
    }
}

impl ActionChipElement {
    pub fn new(widget: &ActionChip) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&ActionChipStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ActionChipElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ActionChipElement {
    fn destroy(&self) {
        // self.base.destroy();
