...
#[derive(Debug, Clone)]
pub struct LinearProgressIndicatorStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct LinearProgressIndicatorElement {
    ...
    pub onchange: Signal<LinearProgressIndicatorStateChangeEvent>,
...
impl LinearProgressIndicatorElement {
    pub fn new(widget: &LinearProgressIndicator) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&LinearProgressIndicatorStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for LinearProgressIndicatorElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for LinearProgressIndicatorElement {
    fn destroy(&self) {
        // self.base.destroy();
