...
#[derive(Debug, Clone)]
pub struct ListTileStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ListTileElement {
    ...
    pub onchange: Signal<ListTileStateChangeEvent>,
...
impl ListTileElement {
    pub fn new(widget: &ListTile) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&ListTileStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ListTileElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ListTileElement {
    fn destroy(&self) {
        // self.base.destroy();
