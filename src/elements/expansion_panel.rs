...
#[derive(Debug, Clone)]
pub struct ExpansionPanelStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ExpansionPanelElement {
    ...
    pub onchange: Signal<ExpansionPanelStateChangeEvent>,
...
impl ExpansionPanelElement {
    pub fn new(widget: &ExpansionPanel) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&ExpansionPanelStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ExpansionPanelElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ExpansionPanelElement {
    fn destroy(&self) {
        // self.base.destroy();
