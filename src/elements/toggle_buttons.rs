...
#[derive(Debug, Clone)]
pub struct ToggleButtonsStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ToggleButtonsElement {
    ...
    pub onchange: Signal<ToggleButtonsStateChangeEvent>,
...
impl ToggleButtonsElement {
    pub fn new(widget: &ToggleButtons) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&ToggleButtonsStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ToggleButtonsElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ToggleButtonsElement {
    fn destroy(&self) {
        // self.base.destroy();
