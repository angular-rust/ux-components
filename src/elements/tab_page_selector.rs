...
#[derive(Debug, Clone)]
pub struct TabPageSelectorStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct TabPageSelectorElement {
    ...
    pub onchange: Signal<TabPageSelectorStateChangeEvent>,
...
impl TabPageSelectorElement {
    pub fn new(widget: &TabPageSelector) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&TabPageSelectorStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for TabPageSelectorElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for TabPageSelectorElement {
    fn destroy(&self) {
        // self.base.destroy();
