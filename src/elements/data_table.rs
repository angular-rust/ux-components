...
#[derive(Debug, Clone)]
pub struct DataTableStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct DataTableElement {
    ...
    pub onchange: Signal<DataTableStateChangeEvent>,
...
impl Debug for DataTableElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("DataTableElement").finish()
    }
}

impl DataTableElement {
    pub fn new(widget: &DataTable) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&DataTableStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for DataTableElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for DataTableElement {
    fn destroy(&self) {
        // self.base.destroy();
