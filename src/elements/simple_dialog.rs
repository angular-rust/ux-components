...
#[derive(Debug, Clone)]
pub struct SimpleDialogStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct SimpleDialogElement {
    ...
    pub onchange: Signal<SimpleDialogStateChangeEvent>,
...
impl Debug for SimpleDialogElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("SimpleDialogElement").finish()
    }
}

impl SimpleDialogElement {
    pub fn new(widget: &SimpleDialog) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&SimpleDialogStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for SimpleDialogElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for SimpleDialogElement {
    fn destroy(&self) {
        // self.base.destroy();
