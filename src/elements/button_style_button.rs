...
#[derive(Debug, Clone)]
pub struct ButtonStyleButtonStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ButtonStyleButtonElement {
    ...
    pub onchange: Signal<ButtonStyleButtonStateChangeEvent>,
...
impl ButtonStyleButtonElement {
    pub fn new(widget: &ButtonStyleButton) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&ButtonStyleButtonStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ButtonStyleButtonElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ButtonStyleButtonElement {
    fn destroy(&self) {
        // self.base.destroy();
