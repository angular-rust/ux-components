...
/// A Drawer is a layout-only object and it do not requires a rendering instance.
...
impl Debug for DrawerElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("DrawerElement").finish()
    }
}
...
impl DrawerElement {
    pub fn new(widget: &Drawer) -> Self {
        ...
        //     log::warn!("Got signal to render Drawer");
        // });
