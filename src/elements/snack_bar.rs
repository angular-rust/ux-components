...
#[derive(Debug, Clone)]
pub struct SnackBarStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct SnackBarElement {
    ...
    pub onchange: Signal<SnackBarStateChangeEvent>,
...
impl SnackBarElement {
    pub fn new(widget: &SnackBar) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&SnackBarStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for SnackBarElement {
