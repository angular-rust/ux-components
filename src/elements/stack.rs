...
/// A Stack is a layout-only object and it do not requires a rendering instance.
...
impl Debug for StackElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("StackElement").finish()
    }
}

impl StackElement {
    pub fn new(widget: &Stack) -> Self {
        ...
        //     log::warn!("Got signal to render Stack");
        // });
...
impl AsRef<RefCell<WidgetComponent>> for StackElement {
