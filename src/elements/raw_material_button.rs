...
#[derive(Debug, Clone)]
pub struct RawMaterialButtonStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct RawMaterialButtonElement {
    ...
    pub onchange: Signal<RawMaterialButtonStateChangeEvent>,
...
impl RawMaterialButtonElement {
    pub fn new(widget: &RawMaterialButton) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&RawMaterialButtonStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for RawMaterialButtonElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for RawMaterialButtonElement {
    fn destroy(&self) {
        // self.base.destroy();
