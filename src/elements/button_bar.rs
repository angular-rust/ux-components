...
#[derive(Debug, Clone)]
pub struct ButtonBarStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct ButtonBarElement {
    ...
    pub onchange: Signal<ButtonBarStateChangeEvent>,
...
impl Debug for ButtonBarElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("ButtonBarElement").finish()
    }
}

impl ButtonBarElement {
    pub fn new(widget: &ButtonBar) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange
            .emit(&ButtonBarStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for ButtonBarElement {
    fn as_ref(&self) -> &RefCell<WidgetComponent> {
        self.component.as_ref()
    }
}

impl Element for ButtonBarElement {
    fn destroy(&self) {
        // self.base.destroy();
