...
/// A Align is a layout-only object and it do not requires a rendering instance.
...
pub struct AlignElement {
    ...
    state: RefCell<AlignState>,

    // The node in layout system
    pub node: Node,
}

impl Debug for AlignElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("AlignElement").finish()
    }
}

impl AlignElement {
    pub fn new(widget: &Align) -> Self {
        ...
        //     log::warn!("Got signal to render Align");
        // });
