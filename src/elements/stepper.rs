...
#[derive(Debug, Clone)]
pub struct StepperStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct StepperElement {
    ...
    pub onchange: Signal<StepperStateChangeEvent>,
...
impl StepperElement {
    pub fn new(widget: &Stepper) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&StepperStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for StepperElement {
