...
#[derive(Debug, Clone)]
pub struct CardStateChangeEvent {
    value: bool,
    prev: bool,
}
...
pub struct CardElement {
    ...
    pub onchange: Signal<CardStateChangeEvent>,
...
impl Debug for CardElement {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        f.debug_struct("CardElement").finish()
    }
}

impl CardElement {
    pub fn new(widget: &Card) -> Self {
    ...
    pub fn set_state(&mut self, value: bool) {
        ...
        self.onchange.emit(&CardStateChangeEvent { value, prev });
    }
}

impl AsRef<RefCell<WidgetComponent>> for CardElement {
