use crate::{
    elements::{Element, RaisedButtonElement},
...
#[deprecated(note = "This class is deprecated, please use ElevatedButton instead.")]
pub struct RaisedButton {
    pub key: Key,
...
#[allow(deprecated)]
impl Widget for RaisedButton {
    fn create_element(&self) -> Box<dyn Element> {
        box RaisedButtonElement::new(self)
    }
}

#[allow(deprecated)]
impl WidgetProperties for RaisedButton {
    fn key(&self) -> &Key {
        &self.key
    }
